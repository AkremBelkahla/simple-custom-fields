                        ...
                        <div id="scf-activation"
                            ...
                            <div class="inside">
                                <div class="misc-pub-section">
                                    <label class="components-toggle-control__label">
                                        <input type="checkbox"
                                               name="status"
                                               value="1"
                                               <?php echo (!$group || $group->post_status === 'publish') ? 'checked' : ''; ?>>
                                        Activer ce groupe
                                    </label>
                                </div>
                            </div>
...
<script type="text/template"
    ...
    <tr class="scf-field-row">
        ...
        <td class="column-actions">
            <button type="button" class="button edit-options" style="display: none">
...
<div id="optionsModal"
    ...
    <div class="scf-modal-content">
        ...
        <div class="scf-modal-footer">
            <button type="button"
                    class="button button-secondary close-modal">Annuler</button>
            <button type="button"
                    class="button button-primary save-options">Enregistrer</button>
        </div>
    </div>
</div>
