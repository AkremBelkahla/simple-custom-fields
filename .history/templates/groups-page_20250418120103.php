...
<div class="wrap">
    ...
    <a href="<?php echo admin_url('admin.php?page=scf-add-group'); ?>" class="page-title-action">Ajouter un groupe</a>
    ...
    <div class="scf-wrap">
                ...
                <table class="wp-list-table widefat fixed striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Nombre de champs</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td>
                                    <strong>
                                        <a href="<?php echo admin_url('admin.php?page=scf-add-group&group_id=' . $group->ID); ?>" class="row-title">
                                ...
                                <td>
                                    <div class="row-actions">
                                        ...
                                        <span class="delete">
                                            <a href="#" class="scf-delete-group" data-group-id="<?php echo $group->ID; ?>">
                                                Supprimer
                                            </a>
                                        </span>
                                    </div>
        ...
        <?php else: ?>
            <div class="scf-no-items">
                ...
                <p>
                    <a href="<?php echo admin_url('admin.php?page=scf-add-group'); ?>" class="button button-primary">
