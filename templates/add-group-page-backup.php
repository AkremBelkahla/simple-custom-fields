...
<div class="wrap">
    ...
    <form id="scf-form"
        ...
        <div class="scf-main-container">
            <div class="scf-content-area">
                <div id="poststuff">
                    <div id="post-body" class="metabox-holder columns-2">
                        <div id="post-body-content">
                            <div id="titlediv">
                                <div id="titlewrap">
                                    <label for="title" class="screen-reader-text">Titre du groupe</label>
                                    <input type="text"
                                           name="title"
                                           id="title"
                                           class="regular-text"
                        ...
                        <div id="postbox-container-2" class="postbox-container">
                            <div id="normal-sortables" class="meta-box-sortables ui-sortable">
                                <div id="scf-fields" class="postbox">
                                    <div class="hndle">
                                        <span>Champs personnalisés (<?php echo count($fields); ?>)</span>
                                    </div>
                                    <div class="inside">
